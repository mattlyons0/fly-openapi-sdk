...
module FlySDK
  class ApiMachinePort
    ...
    attr_accessor :proxy_proto_options

    attr_accessor :start_port

    attr_accessor :tls_options
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlySDK::ApiMachinePort` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlySDK::ApiMachinePort`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'force_https')
        self.force_https = attributes[:'force_https']
      end
      ...
      if attributes.key?(:'http_options')
        self.http_options = attributes[:'http_options']
      end
      ...
      if attributes.key?(:'proxy_proto_options')
        self.proxy_proto_options = attributes[:'proxy_proto_options']
      end
      ...
      if attributes.key?(:'tls_options')
        self.tls_options = attributes[:'tls_options']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          handlers == o.handlers &&
          http_options == o.http_options &&
          port == o.port &&
          proxy_proto_options == o.proxy_proto_options &&
    ...
    def hash
      [end_port, force_https, handlers, http_options, port, proxy_proto_options, start_port, tls_options].hash
    end
