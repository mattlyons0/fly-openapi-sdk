...
module FlySDK
  class UpdateMachineRequest
    ...
    attr_accessor :skip_service_registration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlySDK::UpdateMachineRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlySDK::UpdateMachineRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lease_ttl')
        self.lease_ttl = attributes[:'lease_ttl']
      end

      if attributes.key?(:'lsvd')
        self.lsvd = attributes[:'lsvd']
      end
      ...
      if attributes.key?(:'skip_launch')
        self.skip_launch = attributes[:'skip_launch']
      end

      if attributes.key?(:'skip_service_registration')
        self.skip_service_registration = attributes[:'skip_service_registration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          lease_ttl == o.lease_ttl &&
          lsvd == o.lsvd &&
          name == o.name &&
          region == o.region &&
          skip_launch == o.skip_launch &&
          skip_service_registration == o.skip_service_registration
    end
    ...
    def hash
      [config, current_version, lease_ttl, lsvd, name, region, skip_launch, skip_service_registration].hash
    end
