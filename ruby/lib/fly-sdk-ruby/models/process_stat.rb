  ...
  class ProcessStat
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlySDK::ProcessStat` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlySDK::ProcessStat`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'listen_sockets')
        if (value = attributes[:'listen_sockets']).is_a?(Array)
          self.listen_sockets = value
        end
      end
      ...
      if attributes.key?(:'rtime')
        self.rtime = attributes[:'rtime']
      end

      if attributes.key?(:'stime')
        self.stime = attributes[:'stime']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          listen_sockets == o.listen_sockets &&
          pid == o.pid &&
          rss == o.rss &&
          rtime == o.rtime &&
          stime == o.stime
    ...
    def hash
      [command, cpu, directory, listen_sockets, pid, rss, rtime, stime].hash
    end
