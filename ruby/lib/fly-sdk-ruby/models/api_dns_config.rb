...
module FlySDK
  class ApiDNSConfig
    ...
    attr_accessor :skip_registration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FlySDK::ApiDNSConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FlySDK::ApiDNSConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'skip_registration')
        self.skip_registration = attributes[:'skip_registration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          options == o.options &&
          searches == o.searches &&
          skip_registration == o.skip_registration
    end
    ...
    def hash
      [nameservers, options, searches, skip_registration].hash
    end
