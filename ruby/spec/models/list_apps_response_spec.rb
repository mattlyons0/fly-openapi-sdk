...
# Unit tests for FlySDK::ListAppsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlySDK::ListAppsResponse do
  let(:instance) { FlySDK::ListAppsResponse.new }

  describe 'test an instance of ListAppsResponse' do
    it 'should create an instance of ListAppsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlySDK::ListAppsResponse)
    end
  end
  ...
  describe 'test attribute "total_apps"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
