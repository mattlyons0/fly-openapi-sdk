...
# Unit tests for FlySDK::ApiDnsOption
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlySDK::ApiDnsOption do
  let(:instance) { FlySDK::ApiDnsOption.new }

  describe 'test an instance of ApiDnsOption' do
    it 'should create an instance of ApiDnsOption' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlySDK::ApiDnsOption)
    end
  end
