...
# Unit tests for FlySDK::CreateLeaseRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlySDK::CreateLeaseRequest do
  let(:instance) { FlySDK::CreateLeaseRequest.new }

  describe 'test an instance of CreateLeaseRequest' do
    it 'should create an instance of CreateLeaseRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlySDK::CreateLeaseRequest)
    end
  end
