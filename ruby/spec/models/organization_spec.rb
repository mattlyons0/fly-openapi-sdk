...
# Unit tests for FlySDK::Organization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlySDK::Organization do
  let(:instance) { FlySDK::Organization.new }

  describe 'test an instance of Organization' do
    it 'should create an instance of Organization' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlySDK::Organization)
    end
  end
