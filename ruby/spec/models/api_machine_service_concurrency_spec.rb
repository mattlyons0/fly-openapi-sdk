...
# Unit tests for FlySDK::ApiMachineServiceConcurrency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FlySDK::ApiMachineServiceConcurrency do
  let(:instance) { FlySDK::ApiMachineServiceConcurrency.new }

  describe 'test an instance of ApiMachineServiceConcurrency' do
    it 'should create an instance of ApiMachineServiceConcurrency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FlySDK::ApiMachineServiceConcurrency)
    end
  end

  describe 'test attribute "hard_limit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "soft_limit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
