...
public class HTTPResponseOptions implements AdditionalDataHolder, Parsable {
    /**
    ...
    public static HTTPResponseOptions createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new HTTPResponseOptions();
    }
    /**
    ...
    public HTTPResponseOptionsHeaders getHeaders() {
        return this.headers;
    }
    /**
