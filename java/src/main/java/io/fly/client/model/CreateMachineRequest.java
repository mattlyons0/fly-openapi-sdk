 ...
 */
@JsonPropertyOrder({
  CreateMachineRequest.JSON_PROPERTY_CONFIG,
  CreateMachineRequest.JSON_PROPERTY_LEASE_TTL,
  CreateMachineRequest.JSON_PROPERTY_LSVD,
  CreateMachineRequest.JSON_PROPERTY_NAME,
  CreateMachineRequest.JSON_PROPERTY_REGION,
