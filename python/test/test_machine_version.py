...
class TestMachineVersion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MachineVersion:
        """Test MachineVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MachineVersion`
        """
        model = MachineVersion()
        if include_optional:
            return MachineVersion(
                user_config = fly_sdk.models.api/machine_config.api.MachineConfig(
                    auto_destroy = True, 
                    checks = {
