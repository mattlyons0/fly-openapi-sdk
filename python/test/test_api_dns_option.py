...
class TestApiDnsOption(unittest.TestCase):
    """ApiDnsOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiDnsOption:
        """Test ApiDnsOption
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiDnsOption`
        """
        model = ApiDnsOption()
        if include_optional:
            return ApiDnsOption(
