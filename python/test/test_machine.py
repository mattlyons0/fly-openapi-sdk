...
class TestMachine(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Machine:
        ...
        if include_optional:
            return Machine(
                checks = [
                    fly_sdk.models.check_status.CheckStatus(
                        name = '', 
                        output = '', 
                        status = '', 
                        updated_at = '', )
                ...
                created_at = '',
                events = [
                    fly_sdk.models.machine_event.MachineEvent(
                        id = '', 
                        request = fly_sdk.models.request.request(), 
                        source = '', 
                        status = '', 
                        timestamp = 56, 
                        type = '', )
                ...
                id = '',
                image_ref = fly_sdk.models.image_ref.ImageRef(
                    digest = '', 
                    labels = {
                        'key' : ''
                        }, 
