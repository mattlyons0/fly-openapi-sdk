...
from fly_sdk.api_response import ApiResponse, T as ApiResponseT
import fly_sdk.models
from fly_sdk import rest
from fly_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(fly_sdk.models, klass)
