...
class ApiHTTPOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["compress", "h2_backend", "response"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "response": ApiHTTPResponseOptions.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
