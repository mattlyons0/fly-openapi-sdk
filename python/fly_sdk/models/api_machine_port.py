...
class ApiMachinePort(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "http_options": ApiHTTPOptions.from_dict(obj["http_options"]) if obj.get("http_options") is not None else None,
            "port": obj.get("port"),
            "proxy_proto_options": ApiProxyProtoOptions.from_dict(obj["proxy_proto_options"]) if obj.get("proxy_proto_options") is not None else None,
            "start_port": obj.get("start_port"),
            "tls_options": ApiTLSOptions.from_dict(obj["tls_options"]) if obj.get("tls_options") is not None else None
        })
        return _obj
