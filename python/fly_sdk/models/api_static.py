...
class ApiStatic(BaseModel):
    """
    ApiStatic
    """ # noqa: E501
    guest_path: StrictStr
    tigris_bucket: Optional[StrictStr] = None
    url_prefix: StrictStr
    __properties: ClassVar[List[str]] = ["guest_path", "tigris_bucket", "url_prefix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tigris_bucket": obj.get("tigris_bucket"),
