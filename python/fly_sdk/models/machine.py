...
class Machine(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checks": [CheckStatus.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None,
            "config": ApiMachineConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "created_at": obj.get("created_at"),
            "events": [MachineEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "id": obj.get("id"),
            "image_ref": ImageRef.from_dict(obj["image_ref"]) if obj.get("image_ref") is not None else None,
