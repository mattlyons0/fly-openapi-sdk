...
class MachineVersion(BaseModel):
    ...
    MachineVersion
    """ # noqa: E501
    user_config: Optional[ApiMachineConfig] = None
    version: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["user_config", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_config": ApiMachineConfig.from_dict(obj["user_config"]) if obj.get("user_config") is not None else None,
