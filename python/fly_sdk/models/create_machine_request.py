...
class CreateMachineRequest(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[ApiMachineConfig] = Field(default=None, description="An object defining the Machine configuration")
    ...
    __properties: ClassVar[List[str]] = ["config", "lease_ttl", "lsvd", "name", "region", "skip_launch", "skip_service_registration"]
