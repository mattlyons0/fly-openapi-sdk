...
class ApiDNSConfig(BaseModel):
    """
    ApiDNSConfig
    """ # noqa: E501
    nameservers: Optional[List[StrictStr]] = None
    options: Optional[List[ApiDnsOption]] = None
    searches: Optional[List[StrictStr]] = None
    skip_registration: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["nameservers", "options", "searches", "skip_registration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "options": [ApiDnsOption.from_dict(_item) for _item in obj["options"]] if obj.get("options") is not None else None,
            "searches": obj.get("searches"),
            "skip_registration": obj.get("skip_registration")
        })
        return _obj
